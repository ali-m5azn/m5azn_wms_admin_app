...
Future generateShippingPDF() async {
...
Future<String> getFilePath() async {
  ...
  return '${directory.path}/shipment_orders_invoice.pdf';
}

pw.Widget buildTableSale() {
  return pw.Column(children: [
    _buildTableHeader(),
    ...shippingOrderList.map((e) => _buildTableRow(e)),
  ]);
}

pw.Widget _buildTableHeader() {
  return pw.Row(
    children: shippingOrderLabel.asMap().entries.map((entry) {
...
pw.Widget _buildTableRow(ShippingOrderModel item) {
  return pw.Row(
    children: [
      ...[
        item.date,
